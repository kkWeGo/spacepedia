...
<html>
    ...
    <body id="body" onscroll="scroll()" style="overflow: scroll">
        ...
        <ul class="navbar notfixed" id="navbar">
            <li><a href="#introcorpicelestistep">CORPI CELESTI</a></li>
            <li><a href="#introraggruppamentistep">RAGGRUPPAMENTI</a></li>
            <li><a href="#introastronomistep">ASTRONOMI</a></li>
        ...
        <!-- DIV CORPI CELESTI -->
        <span id="introcorpicelestistep"></span>
        ...
        <!-- DIV RAGGRUPPAMENTI -->
        <span id="introraggruppamentistep"></span>
        ...
        <span id="introastronomistep"></span>
